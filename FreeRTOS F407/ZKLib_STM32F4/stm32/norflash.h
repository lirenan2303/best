...
#define NORFLASH_GATEWAY_STRATEGY_BASE        ((u32)0x00007000)//ASCII码存储*2
...
#define STRATEGY_UNIT_BASE                      ((u32)0x0000003A)//(0x00000000-0x00000006)
#define STRATEGY_TIME_FALG_OFFSET               ((u32)0x0000003A)//(0x00000008-0x0000001E)共12*2个字节ASCII码存储策略同步标识
#define STRATEGY_TYPE_OFFSET                    ((u32)0x00000052)//(0x00000020-0x00000022)共2*2个字节ASCII码存储方案类型
#define STRATEGY_STAGE_NUM_OFFSET               ((u32)0x00000056)//(0x00000024-0x00000024)共1*2个字节ASCII码存储调光段数 
#define STRATEGY_FIRST_STATE_OFFSET             ((u32)0x00000058)//(0x00000026-0x00000030)共6*2个字节ASCII码存储调光功率及时间 
#define STRATEGY_SECOND_STATE_OFFSET            ((u32)0x00000064)//(0x00000032-0x0000003C)共6*2个字节ASCII码存储调光功率及时间
#define STRATEGY_THIRD_STATE_OFFSET             ((u32)0x00000070)//(0x0000003E-0x00000048)共6*2个字节ASCII码存储调光功率及时间
#define STRATEGY_FOURTH_STATE_OFFSET            ((u32)0x0000007C)//(0x0000004A-0x00000054)共6*2个字节ASCII码存储调光功率及时间
#define STRATEGY_FIFTH_STATE_OFFSET             ((u32)0x00000088)//(0x00000056-0x00000060)共6*2个字节ASCII码存储调光功率及时间
